...
public class BitsUserDetailsImpl implements UserDetails {
  ...
  public BitsUserDetailsImpl(Long id, String username, String email, String password,
  ...
  public static BitsUserDetailsImpl build(User user) {
    ...
    return new BitsUserDetailsImpl(
        user.getId(), 
        user.getUsername(), 
        user.getEmail(),
        user.getPassword(), 
  ...
  public boolean equals(Object o) {
    ...
    if (o == null || getClass() != o.getClass())
      return false;
    BitsUserDetailsImpl user = (BitsUserDetailsImpl) o;
